...
static void free_state(lp_speed_meter_state_t *state)
{
...
static VOID CALLBACK on_destroy_wait_complete(PVOID context, BOOLEAN timed_out)
{
    (void)timed_out;
    lp_speed_meter_state_t *state = (lp_speed_meter_state_t *)context;
